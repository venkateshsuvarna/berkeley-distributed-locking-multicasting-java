#This python file is client 3 which can send messages to client 1 and 2 based on user choice
	...
	while True:
		...
		if(user_choice_int == 1):
			...
			try:
				...
				time.sleep(5)
				s.sendall((str(timestamp_client_3)).encode())
				time.sleep(5)
				s.close
...
def receive_message(message, machine, timestamp) :
	...
	timestamp_client_3 = (int)(timestamp_client_3)
	timestamp_client_3 = (int)(timestamp) + 1
	print("Timestamp of Machine 3 is : "+(str)(timestamp_client_3))
	return;
...
try:
	...
	timestamp_client_3 = 0
	print ("Initial Timestamp is " + str(timestamp_client_3))
